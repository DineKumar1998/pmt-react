...
import { getClientParameterList, exportParameterList, getClientSelectedParameters } from "@/apis/parameter";
...
const ClientParameters: React.FC = () => {
    ...
    const handleEditParameter = (param: any) => {
        navigate(`/member-list/${encodeURIComponent(memberName)}/parameters/${param.id}`, {
            state: {
                clientId: clientId,
                isPrimary: activeTab === "primary",
            }
