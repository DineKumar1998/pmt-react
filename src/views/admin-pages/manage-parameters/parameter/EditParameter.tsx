...
const EditParameter = () => {
    ...
    const [state, setState] = useState<{ isOpen: boolean; selectedIndustryId: null | number }>({
        isOpen: false,
    ...
    const { mutateAsync: deleteParameterIndustryMappingMutate } =
        useMutation({
    ...
    const handleNavigateParam = (direction: "prev" | "next") => {
        ...
        navigate(`/manage-parameters/${nextParam.id}`, {
            replace: true,
        });
    ...
    const actions = (
        <div className="parent-actions">
            ...
            <div className="actions-right">
                <NavLink to={`/manage-parameters/${editParamId}/industry-map?parameterName=${encodeURIComponent(paramData?.question)}`} >
                    <Button
                ...
                <section className="parameters-list" ref={rightRef}>
                    <ul>
                        {parameterList.map((parameter) =>
                            ...
                            >
                                <NavLink to={`/manage-parameters/${parameter.id}`}>
            ...
            <CustomModal
                ...
                onConfirm={async () => {
                    if (state.selectedIndustryId) {
                        await deleteParameterIndustryMappingMutate(state.selectedIndustryId);
